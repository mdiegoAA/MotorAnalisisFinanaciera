<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InformacionValidacionSubirArchivo.aspx.cs" Inherits="MotorAnalisisFianaciera_Amezquita.pages.InformacionValidacionSubirArchivo" %>
...
<head>
    ...
    <script src="../js/InformacionValidacionSubirArchivo.js"></script>
...
<body>
    ...
    <div id="wrapper">
                                   ...
                                   <thead>
                                     ...
                                     <tbody>
                                        <tr>
                                            ...
                                            <td> <div class="col-sm-8"><div id="validacionFecha"><input type="text" placeholder="Fecha Archivo" id="datepicker" class="form-control"></div></div></td>
                                            <td>
                                            <div class="row">                                                 
                                                  <div class="col-xs-10">
        ...
        <!-- /#page-wrapper -->
             ...
             <div class="modal fade" id="modalValidacionReemplazarArchivo" tabindex="-1" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Se encontro archivo cargado.Desea Reemplazar la informacion</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" id="btnModalReemplazarDatos" class="btn btn-primary">Reemplazar los datos</button>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->

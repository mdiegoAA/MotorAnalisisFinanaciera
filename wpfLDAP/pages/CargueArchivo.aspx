<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargueArchivo.aspx.cs" Inherits="MotorAnalisisFinanciera_Amezquita.CargueArchivo" %>
    ...
    <form id="form1" runat="server" role="form" data-toggle="validator">
        ...
        <div id="wrapper">
                ...
                <div class="col-md-6">
                    <div>
                        <footer>
                            <h5>
                                <p class="text-right">
                                    <asp:Label ID="label1" runat="server" Text="Username" /></p>
                            </h5>
                        </footer>
                        <h5>
                            <p class="text-right">
                                <asp:Label ID="DestruirSession" runat="server"><a href="#">Cerra Session</a></asp:Label></p>
                        </h5>
                    </div>
                </div>
           ...
           <div class="row" id="InformacionTables" style="display: none">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">No se puede guardar la informacion por lo siguientes datos.</h4>
                            </div>
                ...
                <div class="modal fade bs-example-modal-lg" id="modalGuardarInformacion" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title" id="H1">Informacion Correcta.</h4>
                            </div>
                            <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button type="button" id="btnGuardarInformacion" class="btn btn-primary">Save changes</button>
                            </div>
                        </div>
                    </div>
                </div>
